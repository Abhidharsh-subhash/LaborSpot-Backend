"""
Django settings for LaborSpot project.
...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt.token_blacklist',#it is used because if we are trying to use the refresh token more than once it will rejected 
    'drf_yasg',
]
...
#to configure cross origin for chating.
...
STATIC_URL = '/static/'
#added to configure the static files while hosting
